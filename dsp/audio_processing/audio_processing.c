...
void aic3204_loopback_config(void);
void aic3204_close_and_reset(void);
Int16 aic3204_loop_linein(void);

Int16 audio_processing( )
{
    /* Initialize I2C */
    EZDSP5535_I2C_init( );

    aic3204_loopback_config();
